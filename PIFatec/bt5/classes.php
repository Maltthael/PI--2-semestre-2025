      ...
      <ul class="navbar-nav ms-lg-auto align-items-lg-center mb-2 mb-lg-0 navbar">
        ...
        <li class="nav-item">
          <a class="nav-link carrinho d-flex align-items-center" href="carrinho.html">
            <img src="img/icone_carrinho.svg" alt="Carrinho" width="22" height="22">
          </a>
        </li>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-12 col-md-4 mb-3 mb-md-0 text-center text-md-start">
        <a class="navbar-brand" href="dashboard.php">
          <img src="../img/LMinformatica_logo_h (2).svg" alt="Logo" width="180" class="img-fluid">
        </a>
      </div>
  ...
  <div class="container modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3" method="POST" action="nomearquivo.php">
          <div class="col-md-12">
            <label for="nomeCliente" class="form-label">Nome</label>
            <input type="text" class="form-control" id="nomeCliente" placeholder="Digite o nome">
          </div>
          <div class="col-md-12">
            <label for="nomeCliente" class="form-label">Sobrenome</label>
            <input type="text" class="form-control" id="sobrenomeCliente" placeholder="Digite o nome">
          </div>
          <div class="col-md-12">
...
$botao_tabela_produto = '<button title="Editar Estoque" class="btn btn-button" data-bs-toggle="modal" data-bs-target="#modalEditar">
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
      <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"/>
    </svg>
  </button>
  ...
  <button title="Excluir" class="btn btn-button" data-bs-toggle="modal" data-bs-target="#modalExcluir">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
      <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/>
    </svg>
  </button>
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="modalEditarLabel" aria-hidden="true">
  <div class="container modal-dialog">
    <div class="modal-content">
      <div id="ativo" class="modal-header text-white">
        <h5 class="ativo" id="modalEditarLabel">Editar</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
      </div>
      <div class="modal-body">
        <form class="row g-3" method="POST" action="teste">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <label for="Quantidade no estoque" class="form-label">Quantidade</label>
        ...
        <button type="button" class="btn btn-danger w-100" style="margin-top: 15px;" data-bs-dismiss="modal" aria-label="Fechar">Cancelar</button>
      </div>
    </div>
  </div>
</div>
...
$navbar_adm_servicos  = '<<nav class="navbar navbar-expand-lg fixed-top navbar-custom">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            ...
            <li><a class="dropdown-item" href="clientes.php">Clientes</a></li>
            <li><a class="dropdown-item" href="relatorios.php">Relatorios</a></li>
            <li><a class="dropdown-item" id="ativo" href="servicos.php">Ordem de Servico</a></li>
          </ul>
        </li>
      </ul>
...
$navbar_adm_perfil  = '<<nav class="navbar navbar-expand-lg fixed-top navbar-custom">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarUser">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            <li><a class="dropdown-item" id="ativo" href="perfil.php">Perfil</a></li>
            <li><a class="dropdown-item" href="produto.php">Produtos</a></li>
            <li><a class="dropdown-item" href="clientes.php">Clientes</a></li>
            <li><a class="dropdown-item" href="relatorios.php">Relatorios</a></li>
            <li><a class="dropdown-item" href="servicos.php">Ordem de Servico</a></li>
...
$navbar_adm_produto  = '<<nav class="navbar navbar-expand-lg fixed-top navbar-custom">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarUser">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            <li><a class="dropdown-item" href="perfil.php">Perfil</a></li>
            <li><a class="dropdown-item" id="ativo" href="produto.php">Produtos</a></li>
            <li><a class="dropdown-item" href="clientes.php">Clientes</a></li>
            <li><a class="dropdown-item" href="relatorios.php">Relatorios</a></li>
            <li><a class="dropdown-item" href="servicos.php">Ordem de Servico</a></li>
          </ul>
...
$navbar_adm_vendas = '<nav class="navbar navbar-expand-lg fixed-top navbar-custom">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            <li><a class="dropdown-item" href="perfil.php">Perfil</a></li>
            <li><a class="dropdown-item" href="produto.php">Produtos</a></li>
            <li><a class="dropdown-item" id="ativo" href="vendas.php">Vendas</a></li>
            <li><a class="dropdown-item" href="clientes.php">Clientes</a></li>
            <li><a class="dropdown-item" href="relatorios.php">Relatorios</a></li>
            <li><a class="dropdown-item" href="servicos.php">Ordem de Servico</a></li>
          </ul>
