  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      ...
      <ul class="navbar-nav ms-lg-auto align-items-lg-center mb-2 mb-lg-0 navbar">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../Cliente/sobre.html">Sobre Nós</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../Cliente/contato.html">Contato</a>
        </li>
        ...
        <li class="nav-item">
          <a href="../Cliente/entrar.html" class="btn btn-entrar ms-lg-3">
            Entrar
          </a>
        </li>
...
$navbar_adm_relatorio = '<nav class="navbar navbar-expand-lg fixed-top navbar-custom">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
          <li><a class="dropdown-item" id="ativo" href="dashboard.php">Perfil</a></li>
